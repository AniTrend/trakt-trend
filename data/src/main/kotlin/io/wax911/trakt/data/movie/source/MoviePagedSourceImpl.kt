...
import io.wax911.trakt.data.movie.MovieRemoteSource
import io.wax911.trakt.data.movie.PopularMovieController
...
internal class MoviePagedSourceImpl(
    ...
    private val controller: PopularMovieController,
    private val converter: ShowEntityConverter,
    dispatcher: ISupportDispatcher
)  : MoviePagedSource(dispatcher) {
    ...
    override fun observable(): Flow<PagedList<ISharedMediaWithImage>> {
        ...
        return FlowPagedListBuilder(
            ...
            null,
            this@MoviePagedSourceImpl
        ).buildFlow()
    }

    override suspend fun getPopularMovies(callback: RequestCallback) {
